...
def button_pressed(event):
    ...
    print(1)
    resolution = (800, 600)
    star_map = StarMap.StarMap(lat, long, True, False, datetime.datetime(year, month, day, hour, minute, tzinfo=datetime.timezone(datetime.timedelta(hours=0))), resolution)
